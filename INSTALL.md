...
```bash
export CODEX_AGENT_CHAT_ID="你的 Chat_ID"
...
```python
CHAT_ID = os.environ.get("CODEX_AGENT_CHAT_ID", "你的 Chat_ID")
...
| notify 没触发 | 查看 `/tmp/codex_notify_log.txt` |
